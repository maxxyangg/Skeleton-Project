...
public class APIConnector {
	...
	// http://localhost/indic-wp/api/getLogicalChars.php?string=hello&language=English
	// https://indic-wp.thisisjava.com/api/getLogicalChars.php?string=
	public void getLogicalChars() {
		try {
			String string = this.stringInput.replace(" ", "%20");
			string = string.replace("’", "'");
			logicalCharsURL = new URL(
